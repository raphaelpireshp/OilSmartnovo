...
-- Inserir anos dos modelos de moto
INSERT INTO modelo_ano (modelo_id, ano) VALUES 
(41, 2021), (41, 2022), (41, 2023),
(42, 2022), (42, 2023),
(43, 2021), (43, 2022), (43, 2023),
...
-- Adicionando anos para todos os modelos de carros que ainda não têm
INSERT INTO modelo_ano (modelo_id, ano) VALUES 
-- Fiat
(1, 2019), (1, 2018), -- Palio
(2, 2019), (2, 2018), -- Uno
(3, 2020), (3, 2019), -- Strada
(4, 2019), (4, 2018), -- Toro
-- Ford
(5, 2019), (5, 2018), -- Ka
(6, 2019), (6, 2018), -- Fiesta
(7, 2020), (7, 2019), -- EcoSport
(8, 2019), (8, 2018), -- Focus
-- Chevrolet
(9, 2019), (9, 2018), -- Onix
(10, 2019), (10, 2018), -- Celta
(11, 2019), (11, 2018), -- Prisma
(12, 2020), (12, 2019), -- S10
-- Volkswagen
(13, 2019), (13, 2018), -- Gol
(14, 2019), (14, 2018), -- Voyage
(15, 2020), (15, 2019), -- Saveiro
(16, 2019), (16, 2018), -- Polo
-- Toyota
(17, 2019), (17, 2018), -- Corolla
(18, 2020), (18, 2019), -- Hilux
(19, 2019), (19, 2018), -- Etios
(20, 2019), (20, 2018), -- Yaris
-- Honda
(21, 2019), (21, 2018), -- Civic
(22, 2019), (22, 2018), -- Fit
(23, 2020), (23, 2019), -- HR-V
(24, 2019), (24, 2018), -- CR-V
-- Hyundai
(25, 2019), (25, 2018), -- HB20
(26, 2020), (26, 2019), -- Creta
(27, 2019), (27, 2018), -- Tucson
(28, 2019), (28, 2018), -- Santa Fe
-- Renault
(29, 2019), (29, 2018), -- Kwid
(30, 2019), (30, 2018), -- Sandero
(31, 2019), (31, 2018), -- Logan
(32, 2019), (32, 2018), -- Duster
-- Peugeot
(33, 2019), (33, 2018), -- 208
(34, 2020), (34, 2019), -- 2008
(35, 2019), (35, 2018), -- 3008
(36, 2019), (36, 2018), -- Partner
-- Nissan
(37, 2019), (37, 2018), -- March
(38, 2019), (38, 2018), -- Versa
(39, 2020), (39, 2019), -- Kicks
(40, 2019), (40, 2018), -- Frontier
-- Jeep
(41, 2019), (41, 2018), -- Renegade
(42, 2020), (42, 2019), -- Compass
(43, 2019), (43, 2018), -- Commander
(44, 2019), (44, 2018), -- Wrangler
-- BMW
(45, 2019), (45, 2018), -- Série 3
(46, 2020), (46, 2019), -- X5
-- Mercedes-Benz
(47, 2019), (47, 2018), -- Classe C
(48, 2020), (48, 2019), -- GLC
-- Audi
(49, 2019), (49, 2018), -- A4
(50, 2020), (50, 2019), -- Q5
-- Porsche
(51, 2019), (51, 2018), -- 911
(52, 2020), (52, 2019); -- Cayenne

-- Adicionando anos para modelos de motos que ainda não têm
INSERT INTO modelo_ano (modelo_id, ano) VALUES 
-- Yamaha
(53, 2020), (53, 2019), -- CG 160
(54, 2020), (54, 2019), -- Fazer 250
(55, 2020), (55, 2019), -- MT-03
(56, 2020), (56, 2019), -- XTZ 250
-- Suzuki
(57, 2020), (57, 2019), -- Bandit 125
(58, 2020), (58, 2019), -- Burgman 125
(59, 2020), (59, 2019), -- GSX-S750
(60, 2020), (60, 2019), -- V-Strom 650
-- Kawasaki
(61, 2020), (61, 2019), -- Ninja 300
(62, 2020), (62, 2019), -- Z400
(63, 2020), (63, 2019), -- Versys 650
(64, 2020), (64, 2019), -- Z900
-- Harley-Davidson
(65, 2020), (65, 2019), -- Iron 883
(66, 2020), (66, 2019), -- Street 750
(67, 2020), (67, 2019), -- Fat Boy
(68, 2020), (68, 2019), -- Road King
-- Honda motos
(69, 2020), (69, 2019), -- CBR 600RR
(70, 2020), (70, 2019); -- CB 500F

-- Adicionando mais produtos (óleos)
INSERT INTO produto_oleo (nome, tipo, viscosidade, especificacao, marca) VALUES 
('Motul 8100 X-clean+ 5W-40', 'carro', '5W-40', 'API SP, Full Sintético', 'Motul'),
('Motul 8100 Eco-nergy 0W-20', 'carro', '0W-20', 'API SP, Low SAPS', 'Motul'),
('Motul 300V Power Racing 5W-40', 'moto', '5W-40', 'Ester Core, Racing', 'Motul'),
('Motul 7100 4T 10W-50', 'moto', '10W-50', 'API SL, JASO MA2', 'Motul'),
('Motul Multi Power 15W-40', 'carro', '15W-40', 'API SN, Mineral', 'Motul'),
('Motul Scooter Power 5W-40', 'moto', '5W-40', 'JASO MB, Scooters', 'Motul'),
('Motul 8100 X-cess 5W-40', 'carro', '5W-40', 'API SN, Full Sintético', 'Motul'),
('Motul 300V Competition 15W-50', 'moto', '15W-50', 'Ester Core, Racing', 'Motul'),
('Motul Gear Competition 75W-140', 'carro', '75W-140', 'API GL-5, Sintético', 'Motul'),
('Motul Transoil Expert 10W-30', 'moto', '10W-30', 'JASO MA1, Transmissão', 'Motul');

-- Adicionando mais produtos (filtros)
INSERT INTO produto_filtro (nome, tipo, compatibilidade_modelo) VALUES 
('Filtro I606', 'carro', 'BMW X5, Mercedes GLC, Audi Q5'),
('Filtro J707', 'carro', 'Porsche 911, Cayenne'),
('Filtro MOTO-Y80', 'moto', 'Yamaha MT-03, XTZ 250'),
('Filtro MOTO-H90', 'moto', 'Honda CBR 600RR, CB 500F'),
('Filtro K808', 'carro', 'Toyota Hilux, Nissan Frontier'),
('Filtro L909', 'carro', 'Jeep Renegade, Compass'),
('Filtro M101', 'carro', 'Hyundai Creta, Tucson'),
('Filtro N202', 'carro', 'Peugeot 2008, 3008'),
('Filtro O303', 'carro', 'Renault Duster, Logan'),
('Filtro P404', 'carro', 'Fiat Toro, Strada');

-- Distribuindo produtos entre as oficinas de forma equilibrada

-- Oficina Norte (ID 1)
INSERT INTO estoque (oficina_id, produto_id, tipo_produto, quantidade) VALUES 
(1, 9, 'oleo', 12),  -- Motul 8100 X-clean+ 5W-40
(1, 10, 'oleo', 8),  -- Motul 8100 Eco-nergy 0W-20
(1, 11, 'oleo', 15), -- Motul 300V Power Racing 5W-40
(1, 12, 'oleo', 10), -- Motul 7100 4T 10W-50
(1, 5, 'filtro', 20), -- Filtro I606
(1, 6, 'filtro', 15), -- Filtro J707
(1, 7, 'filtro', 25), -- Filtro MOTO-Y80
(1, 8, 'filtro', 18); -- Filtro MOTO-H90

-- Oficina Sul (ID 2)
INSERT INTO estoque (oficina_id, produto_id, tipo_produto, quantidade) VALUES 
(2, 13, 'oleo', 10), -- Motul Multi Power 15W-40
(2, 14, 'oleo', 12), -- Motul Scooter Power 5W-40
(2, 15, 'oleo', 8),  -- Motul 8100 X-cess 5W-40
(2, 16, 'oleo', 15), -- Motul 300V Competition 15W-50
(2, 9, 'filtro', 22), -- Filtro K808
(2, 10, 'filtro', 18), -- Filtro L909
(2, 11, 'filtro', 15), -- Filtro M101
(2, 12, 'filtro', 20); -- Filtro N202

-- Oficina Leste (ID 3)
INSERT INTO estoque (oficina_id, produto_id, tipo_produto, quantidade) VALUES 
(3, 17, 'oleo', 15), -- Motul Gear Competition 75W-140
(3, 18, 'oleo', 10), -- Motul Transoil Expert 10W-30
(3, 9, 'oleo', 12),  -- Motul 8100 X-clean+ 5W-40
(3, 10, 'oleo', 8),  -- Motul 8100 Eco-nergy 0W-20
(3, 13, 'filtro', 25), -- Filtro O303
(3, 14, 'filtro', 20), -- Filtro P404
(3, 5, 'filtro', 15), -- Filtro I606
(3, 6, 'filtro', 18); -- Filtro J707

-- Oficina Centro (ID 4)
INSERT INTO estoque (oficina_id, produto_id, tipo_produto, quantidade) VALUES 
(4, 11, 'oleo', 10), -- Motul 300V Power Racing 5W-40
(4, 12, 'oleo', 12), -- Motul 7100 4T 10W-50
(4, 13, 'oleo', 8),  -- Motul Multi Power 15W-40
(4, 14, 'oleo', 15), -- Motul Scooter Power 5W-40
(4, 15, 'filtro', 20), -- Filtro MOTO-Y80
(4, 16, 'filtro', 15), -- Filtro MOTO-H90
(4, 17, 'filtro', 18), -- Filtro K808
(4, 18, 'filtro', 12); -- Filtro L909

-- Oficina Oeste (ID 5)
INSERT INTO estoque (oficina_id, produto_id, tipo_produto, quantidade) VALUES 
(5, 15, 'oleo', 10), -- Motul 8100 X-cess 5W-40
(5, 16, 'oleo', 12), -- Motul 300V Competition 15W-50
(5, 17, 'oleo', 8),  -- Motul Gear Competition 75W-140
(5, 18, 'oleo', 15), -- Motul Transoil Expert 10W-30
(5, 19, 'filtro', 20), -- Filtro M101
(5, 20, 'filtro', 15), -- Filtro N202
(5, 13, 'filtro', 18), -- Filtro O303
(5, 14, 'filtro', 12); -- Filtro P404

-- Adicionando recomendações para todos os modelos e anos
-- Vou adicionar recomendações genéricas para cada marca, pois seria muito extenso para todos os modelos
...
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Fiat' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Ford' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Chevrolet' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Volkswagen' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Toyota' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Honda' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Honda' AND m.tipo = 'moto';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Yamaha' AND m.tipo = 'moto';

-- BMW
INSERT INTO recomendacao (modelo_ano_id, oleo_id, filtro_id)
SELECT ma.id, 7, 5 FROM modelo_ano ma
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'BMW' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Mercedes-Benz' AND m.tipo = 'carro';
...
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Audi' AND m.tipo = 'carro';

-- Porsche
INSERT INTO recomendacao (modelo_ano_id, oleo_id, filtro_id)
SELECT ma.id, 9, 6 FROM modelo_ano ma
JOIN modelo m ON ma.modelo_id = m.id
JOIN marca mr ON m.marca_id = mr.id
WHERE mr.nome = 'Porsche' AND m.tipo = 'carro';

-- Adicionar coluna preco na tabela produto_oleo
ALTER TABLE produto_oleo ADD COLUMN preco DECIMAL(10,2) DEFAULT 0.00;

-- Adicionar coluna preco na tabela produto_filtro  
ALTER TABLE produto_filtro ADD COLUMN preco DECIMAL(10,2) DEFAULT 0.00;



UPDATE produto_oleo SET preco = 89.90 WHERE id = 1;
UPDATE produto_oleo SET preco = 65.50 WHERE id = 2;
UPDATE produto_oleo SET preco = 120.00 WHERE id = 3;
UPDATE produto_oleo SET preco = 45.80 WHERE id = 4;
UPDATE produto_oleo SET preco = 95.00 WHERE id = 5;
UPDATE produto_oleo SET preco = 75.30 WHERE id = 6;
UPDATE produto_oleo SET preco = 68.90 WHERE id = 7;
UPDATE produto_oleo SET preco = 110.50 WHERE id = 8;
UPDATE produto_oleo SET preco = 50.00 WHERE id > 8;


UPDATE produto_filtro SET preco = 35.90 WHERE id = 1;
UPDATE produto_filtro SET preco = 42.75 WHERE id = 2;
UPDATE produto_filtro SET preco = 38.50 WHERE id = 3;
UPDATE produto_filtro SET preco = 28.90 WHERE id = 4;
UPDATE produto_filtro SET preco = 32.00 WHERE id = 5;
UPDATE produto_filtro SET preco = 45.00 WHERE id = 6;
UPDATE produto_filtro SET preco = 48.50 WHERE id = 7;
UPDATE produto_filtro SET preco = 30.00 WHERE id > 7;

-- Adicionar modelo_ano_id = 22 para um modelo existente (ex: Onix 2022, modelo_id 9)
INSERT INTO modelo_ano (modelo_id, ano) VALUES (9, 2022);

-- Adicionar uma recomendação para o modelo_ano_id = 22
INSERT INTO recomendacao (modelo_ano_id, oleo_id, filtro_id) VALUES (22, 1, 1); -- Usando oleo_id 1 e filtro_id 1 como exemplo



-- Adicionar modelo_ano_id = 24 para um modelo existente (ex: Polo 2022, modelo_id 16)
INSERT INTO modelo_ano (modelo_id, ano) VALUES (16, 2022);

-- Adicionar uma recomendação para o modelo_ano_id = 24
INSERT INTO recomendacao (modelo_ano_id, oleo_id, filtro_id) VALUES (24, 2, 2); -- Usando oleo_id 2 e filtro_id 2 como exemplo



-- Adicionar recomendações para os modelo_ano_id faltantes
INSERT INTO recomendacao (modelo_ano_id, oleo_id, filtro_id) VALUES 
(22, 1, 1),  -- Onix 2022
(24, 2, 2);  -- Polo 2022

-- Verificar se as recomendações foram criadas
SELECT * FROM recomendacao WHERE modelo_ano_id IN (22, 24);

-- Verificar estrutura da tabela produto_oleo
DESCRIBE produto_oleo;

-- Verificar estrutura da tabela produto_filtro  
DESCRIBE produto_filtro;

-- Adicionar coluna preco na tabela produto_oleo se não existir
ALTER TABLE produto_oleo ADD COLUMN preco DECIMAL(10,2) DEFAULT 0.00;

-- Adicionar coluna preco na tabela produto_filtro se não existir
ALTER TABLE produto_filtro ADD COLUMN preco DECIMAL(10,2) DEFAULT 0.00;



-- Verificar se as tabelas existem
SHOW TABLES LIKE 'produto_oleo';
SHOW TABLES LIKE 'produto_filtro';

-- Verificar a estrutura atual das tabelas
DESCRIBE produto_oleo;
DESCRIBE produto_filtro;
