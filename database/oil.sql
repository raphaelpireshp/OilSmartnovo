...
ALTER TABLE agendamento_simples 
MODIFY COLUMN status ENUM('pendente', 'confirmado', 'concluido', 'cancelado', 'divergencia') NOT NULL;



-- Atualizar a estrutura da tabela oficina se necessário
ALTER TABLE oficina 
MODIFY COLUMN horario_abertura TIME DEFAULT '08:00:00',
...
END
WHERE usuario_id BETWEEN 23 AND 42;
