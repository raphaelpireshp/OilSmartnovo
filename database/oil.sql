...
INSERT INTO
    usuario (nome, email, senha, tipo, telefone, cnpj)
VALUES
    (
        "Oficina Norte",
        "adm_norte@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 1234-5678",
        "12.345.678/0001-90"
    ),
...
INSERT INTO
    produto_filtro (nome, tipo, compatibilidade_modelo, preco)
VALUES
    (
        "Filtro de Óleo Universal Carro Pequeno",
        "carro",
        "Compatível com Fiat Palio, Uno, VW Gol, Chevrolet Onix",
        30.00
    ),
    (
        "Filtro de Óleo Universal Carro Médio",
        "carro",
        "Compatível com Ford Focus, Honda Civic, Toyota Corolla",
        35.00
    ),
    (
        "Filtro de Óleo Universal Carro Grande/SUV",
        "carro",
        "Compatível com Jeep Compass, Toyota Hilux, Chevrolet S10",
        40.00
    ),
    (
        "Filtro de Óleo Universal Moto Pequena",
        "moto",
        "Compatível com Honda CG 160, Yamaha Fazer 250",
        25.00
    ),
    (
        "Filtro de Ar Universal Carro Pequeno",
        "carro",
        "Compatível com Fiat Palio, Uno, VW Gol, Chevrolet Onix",
        45.00
    ),
    (
        "Filtro de Ar Universal Carro Médio",
        "carro",
        "Compatível com Ford Focus, Honda Civic, Toyota Corolla",
        50.00
    ),
    (
        "Filtro de Ar Universal Carro Grande/SUV",
        "carro",
        "Compatível com Jeep Compass, Toyota Hilux, Chevrolet S10",
        55.00
    ),
    (
        "Filtro de Ar Universal Moto",
        "moto",
        "Compatível com Honda CG 160, Yamaha Fazer 250",
        30.00
    ),
    (
        "Filtro de Combustível Universal Carro",
        "carro",
        "Compatível com a maioria dos carros a gasolina/etanol",
        20.00
    ),
    (
        "Filtro de Combustível Universal Moto",
        "moto",
        "Compatível com a maioria das motos",
        18.00
    ),
    (
        "Filtro de Cabine Universal Carro",
        "carro",
        "Compatível com a maioria dos carros",
        60.00
    ),
    (
        "Filtro de Óleo Esportivo Carro",
        "carro",
        "Compatível com carros esportivos",
        70.00
    ),
    (
        "Filtro de Ar Esportivo Carro",
        "carro",
        "Compatível com carros esportivos",
        80.00
    ),
    (
        "Filtro de Óleo para Diesel",
        "carro",
        "Compatível com veículos a diesel",
        45.00
    ),
    (
        "Filtro de Ar para Diesel",
        "carro",
        "Compatível com veículos a diesel",
        50.00
    ),
    (
        "Filtro de Óleo Premium Carro",
        "carro",
        "Compatível com carros premium",
        65.00
    );
...
INSERT INTO
    usuario (nome, email, senha, tipo, telefone, cpf)
VALUES
    (
        "Roberto Carlos",
        "roberto.carlos@oficinacentro.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "funcionario",
        "(11) 99887-7766",
        "666.777.888-99"
    ...
    (
        "Patricia Souza",
        "patricia.souza@oficinaoeste.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "funcionario",
        "(11) 99776-6655",
        "777.888.999-00"
...
INSERT INTO
    funcionario (usuario_id, oficina_id, cargo)
VALUES
    (11, 4, "Mecânico"),
    (12, 5, "Atendente");
...
INSERT INTO
    recomendacao (modelo_ano_id, oleo_id, filtro_id)
SELECT
    ma.id,
    2,
    1
...
INSERT INTO
    estoque (oficina_id, produto_id, tipo_produto, quantidade)
VALUES
    (1, 1, 'oleo', 50),
    (1, 2, 'oleo', 40),
    (1, 1, 'filtro', 60),
...
ALTER TABLE oficina
ADD COLUMN telefone VARCHAR(20) AFTER estado;
...
VALUES
    ...
    (
        "Oficina Vila Madalena",
        "adm_vilamada@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9345-6789",
        "93.456.789/0001-01"
...
VALUES
    ...
    (
        17,
        "Motul Oficina Santana",
        "02030-000",
        "Av. Eng. Caetano Álvares, 400",
        "São Paulo",
        "SP",
        "(11) 3333-0010",
        "08:30:00",
    ...
    (
        18,
        "Motul Oficina Pinheiros",
        "05410-000",
        "Rua dos Pinheiros, 600",
        "São Paulo",
        "SP",
        "(11) 3333-0011",
        "09:00:00",
...
VALUES
    ...
    (
        "Oficina Paraisópolis",
        "adm_paraisopolis@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0742",
        "10.074.200/0001-02"
    ...
    (
        "Oficina Cidade Tiradentes",
        "adm_tiradentes@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0743",
        "10.074.300/0001-03"
    ...
    (
        "Oficina Jardim Angela",
        "adm_jangela@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0747",
        "10.074.700/0001-07"
    ...
    (
        "Oficina Vila Prudente",
        "adm_vprudente@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0749",
        "10.074.900/0001-09"
    ...
    (
        "Oficina Cidade Ademar",
        "adm_ademar@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0752",
        "10.075.200/0001-12"
    ...
    (
        "Oficina Jardim São Luís",
        "adm_jsluis@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0754",
        "10.075.400/0001-14"
    ...
    (
        "Oficina Ermelino Matarazzo",
        "adm_ermelino@motul.com",
        "$2a$10$xJwL5v5z5U6ZU5Z5Z5Z5Zu",
        "oficina",
        "(11) 9685-0759",
        "10.075.900/0001-19"
...
VALUES
    (
        23,
        "Motul Oficina Heliópolis",
        "04250-000",
        "Estrada das Lágrimas, 123",
        "São Paulo",
        "SP",
        "(11) 3333-0016",
        "08:00:00",
    ...
    (
        25,
        "Motul Oficina Cidade Tiradentes",
        "08450-000",
        "Av. dos Metalúrgicos, 789",
        "São Paulo",
        "SP",
        "(11) 3333-0018",
        "09:00:00",
    ...
    (
        27,
        "Motul Oficina Capão Redondo",
        "05880-000",
        "Av. Carlos Caldeira, 654",
        "São Paulo",
        "SP",
        "(11) 3333-0020",
        "08:30:00",
    ...
    (
        28,
        "Motul Oficina Grajaú",
        "04840-000",
        "Av. Dona Belmira Marin, 987",
        "São Paulo",
        "SP",
        "(11) 3333-0021",
        "09:00:00",
    ...
    (
        30,
        "Motul Oficina Cidade Dutra",
        "04810-000",
        "Av. Senador Teotônio Vilela, 258",
        "São Paulo",
        "SP",
        "(11) 3333-0023",
        "08:00:00",
    ...
    (
        31,
        "Motul Oficina Vila Prudente",
        "03130-000",
        "Rua Siqueira Bueno, 369",
        "São Paulo",
        "SP",
        "(11) 3333-0024",
        "08:30:00",
    ...
    (
        35,
        "Motul Oficina Pedreira",
        "04455-000",
        "Av. Robert Kennedy, 159",
        "São Paulo",
        "SP",
        "(11) 3333-0028",
        "09:00:00",
    ...
    (
        36,
        "Motul Oficina Jardim São Luís",
        "05840-000",
        "Av. Washington Luís, 357",
        "São Paulo",
        "SP",
        "(11) 3333-0029",
        "08:00:00",
    ...
    (
        37,
        "Motul Oficina Parelheiros",
        "04890-000",
        "Estrada de Parelheiros, 486",
        "São Paulo",
        "SP",
        "(11) 3333-0030",
        "08:30:00",
    ...
    (
        ...
        "Motul Oficina Perus",
        "05200-000",
        "Av. Raimundo Pereira de Magalhães, 753",
        "São Paulo",
        "SP",
        "(11) 3333-0031",
        "09:00:00",
    ...
    (
        39,
        "Motul Oficina Jaraguá",
        "05180-000",
        "Av. Elísio Teixeira Leite, 264",
        "São Paulo",
        "SP",
        "(11) 3333-0032",
        "08:00:00",
    ...
    (
        41,
        "Motul Oficina Ermelino Matarazzo",
        "03810-000",
        "Av. Paranaguá, 681",
        "São Paulo",
        "SP",
    ...
    (
        42,
        "Motul Oficina Guaianases",
        "08440-000",
        "Av. Dr. Assis Ribeiro, 294",
        "São Paulo",
        "SP",
        "(11) 3333-0035",
        "08:00:00",
...
VALUES
    ...
    (
        "Óleo Semissintético 20W-50 Moto",
        "moto",
        "20W-50",
        "JASO MA",
        "Castrol",
    ...
    (
        "Óleo Semissintético 10W-30 Moto",
        "moto",
        "10W-30",
        "JASO MB",
        "Yamalube",
...
VALUES
    (
        "Filtro de Óleo Específico Fiat",
        "carro",
        "Fiat Palio, Uno, Siena, Strada",
        32.00
    ),
    (
        "Filtro de Óleo Específico Volkswagen",
        "carro",
        "VW Gol, Voyage, Saveiro, Polo",
        34.00
    ),
    (
        "Filtro de Óleo Específico Honda",
        "carro",
        "Honda Civic, Fit, City, HR-V",
        36.00
    ),
    (
        "Filtro de Óleo Específico Toyota",
        "carro",
        "Toyota Corolla, Etios, Yaris, Hilux",
        38.00
    ),
    (
        "Filtro de Ar Específico Fiat",
        "carro",
        "Fiat Palio, Uno, Siena, Strada",
        48.00
    ),
    (
        "Filtro de Ar Específico Volkswagen",
        "carro",
        "VW Gol, Voyage, Saveiro, Polo",
        52.00
    ),
    (
        "Filtro de Ar Específico Honda",
        "carro",
        "Honda Civic, Fit, City, HR-V",
        56.00
    ),
    (
        "Filtro de Ar Específico Toyota",
        "carro",
        "Toyota Corolla, Etios, Yaris, Hilux",
        58.00
    ),
    ...
    (
        "Filtro de Óleo para Moto Honda",
        "moto",
        "Honda CG, CB, Biz, NXR",
        28.00
    ),
    (
        "Filtro de Óleo para Moto Yamaha",
        "moto",
        "Yamaha Fazer, Factor, Lander",
        30.00
    ),
    (
        "Filtro de Ar para Moto Universal",
        "moto",
        "Compatível com maioria das motos",
        35.00
    );
...
VALUES
    ...
    ("Ténéré 700", 12, "moto"),
    ("GSX-R1000", 13, "moto"),
    ("V-Strom 1000", 13, "moto"),
    ("Boulevard M109R", 13, "moto"),
    ("Ninja 650", 14, "moto"),
    ("Z650", 14, "moto"),
    ("Vulcan S", 14, "moto"),
    ("Street Glide", 15, "moto"),
    ("Road Glide", 15, "moto"),
    ("Sportster Iron 1200", 15, "moto"),
    ("S1000RR", 16, "moto"),
    ("R1250GS", 16, "moto"),
    ("F850GS", 16, "moto");
...
-- Adicionar colunas para controle de protocolo e status
ALTER TABLE agendamento_simples
ADD COLUMN divergencia TEXT NULL;

ALTER TABLE agendamento_simples
ADD COLUMN cancelado_por VARCHAR(50) NULL COMMENT 'Quem cancelou: cliente, oficina, sistema';

ALTER TABLE agendamento_simples MODIFY COLUMN status ENUM (
    'pendente',
    'confirmado',
    'concluido',
    'cancelado',
...
-- Atualizar a estrutura da tabela oficina se necessário
ALTER TABLE oficina MODIFY COLUMN horario_abertura TIME DEFAULT '08:00:00',
MODIFY COLUMN horario_fechamento TIME DEFAULT '18:00:00',
MODIFY COLUMN dias_funcionamento VARCHAR(50) DEFAULT 'segunda,terca,quarta,quinta,sexta,sabado',
ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;

-- Atualizar as 20 oficinas com horários e dias de funcionamento
UPDATE oficina
SET
    horario_abertura = '08:00:00',
    horario_fechamento = '18:00:00',
    dias_funcionamento = 'segunda,terca,quarta,quinta,sexta,sabado',
    telefone = CASE usuario_id
        WHEN 23 THEN '(11) 3333-0016'
        WHEN 24 THEN '(11) 3333-0017'
        WHEN 25 THEN '(11) 3333-0018'
        WHEN 26 THEN '(11) 3333-0019'
        WHEN 27 THEN '(11) 3333-0020'
        WHEN 28 THEN '(11) 3333-0021'
        WHEN 29 THEN '(11) 3333-0022'
        WHEN 30 THEN '(11) 3333-0023'
        WHEN 31 THEN '(11) 3333-0024'
        WHEN 32 THEN '(11) 3333-0025'
        WHEN 33 THEN '(11) 3333-0026'
        WHEN 34 THEN '(11) 3333-0027'
        WHEN 35 THEN '(11) 3333-0028'
        WHEN 36 THEN '(11) 3333-0029'
        WHEN 37 THEN '(11) 3333-0030'
        WHEN 38 THEN '(11) 3333-0031'
        WHEN 39 THEN '(11) 3333-0032'
        WHEN 40 THEN '(11) 3333-0033'
        WHEN 41 THEN '(11) 3333-0034'
        WHEN 42 THEN '(11) 3333-0035'
    END
WHERE
    usuario_id BETWEEN 23 AND 42;

-- Tabela para horários especiais (feriados, eventos, etc)
CREATE TABLE
    horarios_especiais (
        ...
        FOREIGN KEY (oficina_id) REFERENCES oficina (id) ON DELETE CASCADE,
        UNIQUE KEY unique_oficina_data (oficina_id, data_especial)
    );

-- Tabela para exceções de dias da semana (ex: sexta-feira fecha mais cedo)
CREATE TABLE
    horarios_excecoes (
        id INT PRIMARY KEY AUTO_INCREMENT,
        oficina_id INT NOT NULL,
...
INSERT INTO
    oficina_config (oficina_id, intervalo_agendamento)
SELECT
    id,
    45
FROM
...
SELECT
    o.id,
    o.nome,
    oc.intervalo_agendamento
FROM
    oficina o
    LEFT JOIN oficina_config oc ON o.id = oc.oficina_id
WHERE
    oc.intervalo_agendamento IS NOT NULL;

-- Adicione esta tabela para controlar a capacidade simultânea
CREATE TABLE
    IF NOT EXISTS oficina_capacidade (
        id INT PRIMARY KEY AUTO_INCREMENT,
        oficina_id INT NOT NULL,
        capacidade_simultanea INT DEFAULT 1 COMMENT 'Número de atendimentos simultâneos permitidos',
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        UNIQUE KEY unique_oficina (oficina_id),
        FOREIGN KEY (oficina_id) REFERENCES oficina (id) ON DELETE CASCADE
...
-- Inserir capacidade padrão para todas as oficinas existentes
INSERT INTO
    oficina_capacidade (oficina_id, capacidade_simultanea)
SELECT
    id,
    1
FROM
